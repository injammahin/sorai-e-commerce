...
return [
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'port' => env('DB_PORT', '3306'), 'database' => env('DB_DATABASE', 'aatchala'),
    ...
    'redis' => ['client' => env('REDIS_CLIENT', 'phpredis'), 'options' => ['cluster' => env('REDIS_CLUSTER', 'redis'), 'prefix' => env('REDIS_PREFIX', Str::slug(env('APP_NAME', 'aatchala'), '_').'_database_')]],
];
