...
@php($seoTitle=trim($__env->yieldContent('title')) ?: ($siteSettings['default_meta_title']??'AATCHALA — Authentic Bangladeshi Craft'))
...
<meta property="og:type" content="@yield('og_type','website')"><meta property="og:title" content="{{ $seoTitle }}"><meta property="og:description" content="{{ $seoDescription }}"><meta property="og:url" content="{{ url()->current() }}"><meta property="og:image" content="@yield('og_image',asset('images/logo/AATCHALA-mark.webp'))"><meta name="twitter:card" content="summary_large_image">
<meta name="theme-color" content="#faf8f5"><link rel="icon" href="{{ asset('favicon/favicon.png') }}"><link rel="manifest" href="{{ asset('site.webmanifest') }}">
